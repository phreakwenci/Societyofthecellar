# A Constitutional History of the First Decade

*How the Constitution of the United States of Christ (`Constitution.md`)
changed in its first ten years — not by rewrite but by amendment,
certification, and drift. The models are named in `ConstitutionalModel.md`;
this is what they did over time. One spine, ending at a genuine
inflection: the tenth year is a crisis, not a settlement, and what breaks
is left open for the story to decide.*

> **A note on dating.** The regime counts years from Ratification (Year 0),
> "in the year of the Covenant." The old calendar is not printed on state
> documents but is universally kept in private, which is itself a small
> daily act of the resistance the state cannot see.

---

## The shape of the decade

A single sentence, then the detail: **the country began as a
Magisterialist–Old Republican compromise (Schools III and IV) and drifted,
by lawful increments, toward Theonomist–clerical supremacy (School I
operating the Iranian machinery), until the drift reached the one
...
Magisterialists' win), checked by a real two-witness evidentiary bar and a
clause-by-clause reception of the old Bill of Rights (the Old Republicans'
win), with an elected Presidency of the Covenant as the popular front (the
Evangelicals' consolation) and the Committee on Scriptural Consistency
staffed by the Theonomists who had argued the document should not exist.

The reassurances were deliberate and load-bearing. **Article X §2** kept
the Third, Seventh, Tenth, Fourth (as a pledge-seizure warrant rule),
...
above the body that certified it.

The pattern was set by the founding-era rulings (`DenominationalNotes.md`):

- **CSC 1-01** confined Mosaic law to a "general equity" the state could
  enforce selectively — enough Leviticus to govern, not so much as to
  forbid the governors their shrimp.
- **CSC 1-02** filed the Sermon on the Mount as "eschatological counsel,
...
- **CSC 1-03** put the Jubilee "in abeyance pending the Temple," which
  ...
  Reconstruction Authority (TRA) its permanent reason to exist.
- **CSC 1-04** construed the usury ban's "thy brother" down to
  co-congregants, freeing interstate banking.

The **Covenant Courts** were packed in parallel — not dramatically, just by
attrition and appointment, until "righteous judgment" (Art. IV §1) meant
what the Council needed it to mean. The Old Republicans (School IV) lost
these years one certification at a time, on the record, by procedures they
...
Every drift of this kind has a moment the clerical body stops checking the
elected one and starts *commanding* it. In Iran it was consolidated over
the first decade; in the USofC it came with a **trigger** — and the exact
trigger is a choice the writer can set (a contested presidential election;
a succession in the Chief Overseer's chair; a war finding under the
...
This is the *velayat-e faqih* moment (`ConstitutionalModel.md`, Layer 2)
arriving by drift rather than by decree — the Guardian Council swallowing
the Presidency. The office that gained was the **Chief Overseer**, the
presiding chair of the Council, who by the crisis's end was Supreme Leader
in everything but the title the regime was still too American to use.
...
Assembly of Experts, activated. The Evangelicals (School II), who had
wanted their anointed President supreme, had instead delivered him a
...
- **Art. II (Presidency)** — *as ratified,* an elected head of state
...
- **A new entrenchment device** — the **Cornerstone Certification**: a CSC
  ...
  Hungary's cardinal law (`ConstitutionalModel.md`, Layer 4) imported
  whole: this Council's interpretations become the next Council's
  constitution. CSC 1-01 through 1-04 are retroactively declared
  Cornerstones. Nothing was added to the Word (Deut 4:2 is satisfied);
  everything was added to the reading.

---

## Years 5–7 — The Theonomist Schism

Here the drift meets the contradiction it was built on. The Theonomists
(School I) hold the CSC and have spent five years reading the constitution
into a new shape. But their own founding position is that *the constitution
should not exist* — that a written human text standing above Scripture
violates Deuteronomy 4:2's ban on adding to the Word (`ConstitutionalModel.md`,
School I; Const. Art. I §2). For five years that position was theory. In the
schism it becomes a program.

The argument runs: if the Council can certify the meaning of any clause,
and the Cornerstone device makes those certifications supreme, then the
human Constitution is now merely a *finding-aid* to Scripture — and a
finding-aid that presumes to bind God's Word is the very idol the first
commandment forbids. The radical wing moves to **certify the Constitution
itself as subordinate to direct scriptural rule** — to complete the logic
by dissolving the document into the Law it was always supposed to serve.

This detonates the **Article I §2 paradox** at the center of the whole
edifice. Article I §2 says: where Scripture speaks, the court obeys it;
where Scripture is silent, the Council speaks; where Scriptures conflict,
the CSC harmonizes. The Theonomists say the first clause swallows the other
two — the courts should obey *Scripture*, not the Council's gloss on it.
The Magisterialists (School III) answer that without the gloss there is no
peace, only 613 commandments and 472 catalogued contradictions and every
man his own Overseer. The Old Republicans (School IV), nearly spent, make
their last argument: that the written Constitution is the only thing
standing between the citizen and the naked will of whoever last read the
verse aloud.

And the schism hands the **abolitionist underground** its constitutional
weapon. **Article X §3** — the Old Republicans' cleverest clause — says
nothing in the Constitution repeals any verse of Scripture, "including
those verses which appear in no printed edition of the Code." The
Theonomists have spent five years insisting Scripture outranks every human
text. Very well: **Deuteronomy 23:15-16** — *"Thou shalt not deliver unto
his master the servant which is escaped"* — is Scripture, is unrepealed,
and by the regime's own maximal doctrine is therefore the supreme law of
the land, aimed straight at the heart of the covenant-labor system (Title
V; the Office of Servitude Oversight). The suppressed verse, which "appears
in no printed edition of the Code," is invoked *using the Theonomists' own
argument that the printed Code is nothing beside the Word.* The regime's
most radical clerics and its most hunted dissidents are, briefly and
unbearably, making the same argument. The CSC's harmonization memo on
Deut 23:15-16 enters its double digits and is classified Cornerstone to
keep it out of court.

---

## Years 7–10 — The Inflection

The decade ends at a genuine crossroads, and the history stops here on
purpose. The drift has arrived at a contradiction it cannot certify away,
because both sides are quoting Scripture and the whole regime is built on
Scripture outranking everything. Three roads open, and which one the
country takes is the story:

1. **Hardening.** The Council classifies the schism itself, disciplines the
   radical Theonomists as it disciplines dissidents, retires the elected
   Presidency to pure ceremony, and settles into a stable Iran-form
   clerical state — the elected shell around a clerical core, the
   contradictions managed rather than resolved. Order wins; the country
   becomes what it was drifting toward, and admits it.

2. **Fracture.** A Tribe (or a bloc of them) takes the abolitionist reading
   seriously — invokes Deut 23:15-16 and the deferred Jubilee to declare
   the *United States of Christ itself apostate*, a covenant-breaker under
   its own law — and moves to secede from the secession. The Covenant that
   bound the union becomes the argument that dissolves it. Civil-covenant
   war by the decade's close.

3. **Reform crisis.** The Old Republican remnant and the Evangelical
   populists — enemies on everything else, united in resenting the clerical
   supremacy that ate both their projects — force a Second Convention on the
   Hungarian precedent turned against its makers: capture the capturers,
   lawfully, from inside the rules. What they would write is unknown, which
   is the point.

The tenth year is the year the country decides whether it is Iran (road 1),
the Confederacy again (road 2), or Hungary in reverse (road 3). The
Constitution as-ratified and the Constitution as-drifted have pulled so far
apart that the gap is no longer deniable — and an undeniable gap is the one
thing certification cannot close.

---

## The Constitution, as-ratified vs. as-drifted (Year 0 → Year 10)

A quick-reference table of the mutations, for continuity. Note that **the
text of `Constitution.md` does not change** — that file is the Year-0
artifact. The drift is entirely in reading, certification, and the two new
devices (the convened Seventy, the Cornerstone).

| Clause | As ratified (Yr 0) | As drifted (Yr 10) |
|---|---|---|
...
| — (entrenchment) | ordinary amendment (Art. X §1) | Cornerstone Certification: supermajority to revisit a reading |
| — (head of state) | President supreme in the elected sphere | Chief Overseer supreme in fact; Supreme Leader without the title |

---

## For the writer

The history is a clock, and any scene can be dated by which pressure is
loudest in the room:

- **Set in Years 1–3:** the quiet horror of certification — a right that
  still exists on paper evaporating in a sealed ruling; the only witnesses
  are lawyers nobody believes yet.
- **Set in Years 3–5:** the Supremacy Crisis — the night the Council
  convenes the Seventy; a certified President learning he is not one; the
  Evangelicals realizing what they built.
- **Set in Years 5–7:** the Schism — a radical Theonomist and a hunted
  abolitionist quoting the same verse in the same week for opposite ends;
  the CSC memo that cannot be written and cannot be filed.
- **Set in Years 7–10:** the Inflection — a Tribe's delegation drafting a
  declaration that the nation is apostate; a Second Convention forming; a
  Chief Overseer deciding whether to classify a schism or a country.

And the deepest scene, available in every year: someone reading
`Constitution.md` as ratified — their own founding text, the one that
"kept the Constitution" — beside what it now means, and understanding for
the first time that both are true, and that the gap between them is where
they live.
