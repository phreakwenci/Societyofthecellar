# Agency Registry of the United States of Christ

Every law record's `agency` field must name an agency registered here.
Reuse before inventing — a believable state has a finite org chart.
When adding an agency, give it an acronym, a parent, a one-line mandate,
and one telling institutional detail.

## Constitutional layer

- **The Presidency of the Covenant (POTC)** — head of state and "chief
  steward under Christ." Constitutionally subordinate to Scripture as
  interpreted by the Council of Overseers; practically, whoever controls
  the interpretation controls the country.
...
- **Department of Righteousness (DOR)** — umbrella justice/interior
  department; parent of most enforcement bureaus below.
- **Department of Worship (DOW)** — administers licensed congregations,
  liturgical calendars, and clergy credentialing.
...
## Enforcement bureaus (under DOR unless noted)

- **Bureau of Sabbath Observance (BSO)** — enforces rest-day statutes;
  operates the Sabbath Exemption License system (hospitals, power plants,
  and — after intense lobbying — professional sports).
- **Office of Idolatry Prevention (OIP)** — graven images, shrines,
  competing worship. Its Iconoclasm Division rules on what counts as an
  "image": a perpetual, lucrative ambiguity.
- **Sacred Speech Commission (SSC)** — blasphemy, false swearing, misuse
  of the Name. Maintains the Register of Permitted Exclamations.
- **Family Purity Administration (FPA, under DFO)** — sexual conduct,
  purity codes, menstrual seclusion certification.
- **Bureau of Weights, Measures & Honest Balances (BWM)** — Lev 19:35-36
  made a whole agency. Genuinely popular; its inspectors are folk heroes.
- **Restitution Administration (RA)** — administers the ox-gores-ox layer
  of tort law (Ex 21-22): schedules of restitution, servitude bonds for
  unpayable judgments.
- **Office of Servitude Oversight (OSO, under RA)** — regulates debt
  servitude, the six-year manumission clock (Ex 21:2), and the awl-and-
